...
namespace adventure_cli._models.entities.characters
{
    public class PlayerEntity : CharacterEntity, ICombatEntity
    {
        ...
        public Stats _tempStats { get; set; } // When in battle, these are the stats to be used/updated -- this may be updated later depending on how I structure the combat flow
